...
language using Flask-Babel. It supports multiple languages and runs
on host 0.0.0.0 at port 5000.
"""
...
def before_request() -> None:
    """Run some routines before processing each request.

    This method fetches user information and stores it in the global
